        ...
        <section className="mt-5 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 py-20">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="text-center">
                    <div className="w-36 h-36 mx-auto rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        <img src={imageUrl} alt="Cliff Mathebula" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
                    </div>
                    <h2 className="text-indigo-600 dark:text-indigo-400 uppercase text-sm mt-6 font-semibold tracking-wider">Senior Software Engineer</h2>
                    <h1 className="text-4xl font-bold mt-2 text-gray-900 dark:text-white">Cliff Mathebula</h1>
                    <p className="mt-3 text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                        Full Stack Developer & Cloud Infrastructure Specialist with 6+ years of experience building scalable systems.
                    </p>
                </div>
...
function CodeCard({ title, filename, code }) {
    return (
        <div className="bg-gray-100 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-700 hover:scale-[1.01] hover:bg-gray-200 dark:hover:bg-gray-800 transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
                <span className="text-sm font-semibold text-gray-600 dark:text-gray-300">{title}</span>
                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-mono font-medium bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300">
                    {filename}
                </span>
            </div>
